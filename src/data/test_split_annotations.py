...
df = pd.read_pickle('annotations/allAnnotations20210422_pkv4.pkl')
train, test = train_test_split(df, test_size=0.2, stratify=df[['label', 'day_phase']], random_state=0)
train.to_pickle('annotations/annotations_train.pkl')
test.to_pickle('annotations/annotations_test.pkl')
