# -*- coding: utf-8 -*-
#
# FoggyGAN documentation build configuration file, created by
# sphinx-quickstart.
#
...
htmlhelp_basename = 'Thesis-KNMI-FoggyGANdoc'
...
latex_documents = [
    ('index',
     'Thesis-KNMI-FoggyGAN.tex',
     u'FoggyGAN Documentation',
     u"Thomas ten Heuvel", 'manual'),
]
...
man_pages = [
    ('index', 'Thesis-KNMI-FoggyGAN', u'FoggyGAN Documentation',
     [u"Thomas ten Heuvel"], 1)
]
